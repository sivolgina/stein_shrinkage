...
val_subset_noisy1 = cityscapesLoader(
    root=path_data,
    split='train',
    is_transform=True,
    use_noise=True,
...
val_subset_noisy1 = Subset(val_subset_noisy1, val_subset_base.indices)
val_subset_noisy2 = cityscapesLoader(
    root=path_data,
    split='train',
    is_transform=True,
    use_noise=True,
...
val_subset_noisy2 = Subset(val_subset_noisy2, val_subset_base.indices)

val_subset_noisy3 = cityscapesLoader(
    root=path_data,
    split='train',
    is_transform=True,
    use_noise=True,
...
val_subset_noisy3 = Subset(val_subset_noisy3, val_subset_base.indices)

val_subset_noisy4 = cityscapesLoader(
    root=path_data,
    split='train',
    is_transform=True,
    use_noise=True,
...
val_subset_noisy4 = Subset(val_subset_noisy4, val_subset_base.indices)

val_subset_noisy5 = cityscapesLoader(
    root=path_data,
    split='train',
    is_transform=True,
    use_noise=True,
...
val_subset_noisy5 = Subset(val_subset_noisy5, val_subset_base.indices)


test_data_noisy1 = cityscapesLoader(
    root=path_data,
    split='val',
    is_transform=True,
    use_noise=True,
...
test_data_noisy2 = cityscapesLoader(
    root=path_data,
    split='val',
    is_transform=True,
    use_noise=True,
...
test_data_noisy3 = cityscapesLoader(
    root=path_data,
    split='val',
    is_transform=True,
    use_noise=True,
...
test_data_noisy4 = cityscapesLoader(
    root=path_data,
    split='val',
    is_transform=True,
    use_noise=True,
...
test_data_noisy5 = cityscapesLoader(
    root=path_data,
    split='val',
    is_transform=True,
    use_noise=True,
...
val_loader_noise1 = DataLoader(val_subset_noisy1, batch_size=batch_size, shuffle=False, num_workers=num_workers)
val_loader_noise2 = DataLoader(val_subset_noisy2, batch_size=batch_size, shuffle=False, num_workers=num_workers)
val_loader_noise3 = DataLoader(val_subset_noisy3, batch_size=batch_size, shuffle=False, num_workers=num_workers)
val_loader_noise4 = DataLoader(val_subset_noisy4, batch_size=batch_size, shuffle=False, num_workers=num_workers)
val_loader_noise5 = DataLoader(val_subset_noisy5, batch_size=batch_size, shuffle=False, num_workers=num_workers)
test_loader_noise1 = DataLoader(test_data_noisy1, batch_size=batch_size, shuffle=False, num_workers=num_workers)
test_loader_noise2 = DataLoader(test_data_noisy2, batch_size=batch_size, shuffle=False, num_workers=num_workers)
test_loader_noise3 = DataLoader(test_data_noisy3, batch_size=batch_size, shuffle=False, num_workers=num_workers)
test_loader_noise4 = DataLoader(test_data_noisy4, batch_size=batch_size, shuffle=False, num_workers=num_workers)
test_loader_noise5 = DataLoader(test_data_noisy5, batch_size=batch_size, shuffle=False, num_workers=num_workers)
...
for _ in range(num_runs):
    ...
    for epoch_i in range(train_epochs):
        ...
        val_noise_loaders = [val_loader_noise1, val_loader_noise2, val_loader_noise3, val_loader_noise4, val_loader_noise5]
        val_noises = [validate(loader, model) for loader in val_noise_loaders]

        results = [
            train_loss,
            val_clean["Precision"], val_clean["Senstivity"], val_clean["F1"], val_clean["js"]
        ]
        for noise_metrics in val_noises:
            results += [
                noise_metrics["Precision"], noise_metrics["Senstivity"],
                noise_metrics["F1"], noise_metrics["js"]
            ]
    ...
    test_noise_loaders = [test_loader_noise1, test_loader_noise2, test_loader_noise3, test_loader_noise4, test_loader_noise5]
    epsilons = ["0.03", "0.1", "0.15", "0.2", "0.3"]
    log_test(file_path, model, test_noise_loaders, epsilons)
